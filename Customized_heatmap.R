...
dental_mes_cds <- readRDS("sample_datasets/dental_mesenchymal_lineage_cds.rds")
...
custom_Heatmap(
  ...
  keywords_blacklist= c("epithelium","epithelial","regulated cornification","keratinization","cornification","cartilage","generation","response","chondrocyte","platelet","sensory","neurons","osteoblast","bone","ureteric","kidney","head","septum","enamel","aortic","taxis","endogenous","valve","locomotion","subcellular","movement","axon","luteolysis","chemical","stimulus","mesonephric","substance","differentiation","forebrain","homotypic","embryonic","endodermal","appendage","drug","nephron","renal","tubule","metanephros","free","ubiquitin","chain","poly","polymerization","synaptic","transmission","spontaneous","neurotransmitter","synapse"),
  auto_sort_columns = F,
  load_previous = T,
